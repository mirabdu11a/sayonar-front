      ...
      <div className="container">
        <div className="row">
          <div className="col-md-6 title">
            <h1>Свяжитесь с нами и начните сотрудничество</h1>
            <p>Оставьте заявку — мы свяжемся с вами, чтобы предложить оптимальное решение для вашего бизнеса</p>
          </div>
        </div>
        ...
        <div className="row">
            ...
            <div className='body-contact__info'>
              ...
              <div className='row contact-row'>
                <div className='col-md-6'>
                  ...
                  <h5>Email</h5>
                  <p>Напишите нам для обсуждения сотрудничества</p>
                ...
                <div className='col-md-6 contact-row'>
                  ...
                  <h5>Связь</h5>
                  <p>Оперативно ответим и проконсультируем по всем вопросам</p>
              ...
              <div className='row contact-row'>
                <div className='col-md-6'>
                  ...
                  <h5>Офис</h5>
                  <p>Посетите нас или напишите нам по адресу:</p>
                  <b>г. Ташкент, Миробадский район, ул. Афросиаб, 15/2</b>
                </div>
          ...
          <div className="col-md-6 block ">
            ...
            <form className='body-contact__form' action="">
              <div>
                <p>Имя</p>
              ...
              <div>
                <p>Сообщение</p>
                <textarea name="" placeholder='Кратко опишите ваш запрос или задачу' id=""></textarea>
              </div>
